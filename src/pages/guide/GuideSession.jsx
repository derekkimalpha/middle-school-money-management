  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="text-4xl font-bold text-slate-900">Session Management</h1>
        <p className="text-lg text-slate-600">Configure and manage finance sessions</p>
      </motion.div>
      ...
      {activeSession ? (
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="p-6 rounded-lg bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-green-900">{activeSession.name}</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-green-300">
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="p-6 rounded-lg border-2 border-dashed border-slate-300 space-y-4"
        >
          <h2 className="text-xl font-bold text-slate-900">Start New Session</h2>
          <p className="text-slate-600">Create a new finance session for your students.</p>
