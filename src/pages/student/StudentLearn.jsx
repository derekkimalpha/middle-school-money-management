...
const StudentLearn = () => {
  ...
  return (
    <div className="min-h-screen bg-ds-canvas text-ds-primary font-ds-sans pb-24">
      {/* ── Header ── */}
      <div className="px-8 pt-8 pb-6">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center gap-3">
            <BookOpen className="w-7 h-7 text-ds-secondary" />
            <div>
      ...
      <div className="px-8 mb-5">
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-ds-md bg-ds-inset border border-ds-hairline text-sm text-ds-primary placeholder:text-ds-tertiary focus:outline-none focus:ring-2 focus:ring-ds-accent/30 focus:border-ds-accent"
          />
        </motion.div>
      </div>
        ...
        >
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap flex-shrink-0 border transition-all ${
              activeTopic === null
                ? 'bg-ds-accent text-ds-on-accent border-ds-accent hover:bg-ds-accent-hover'
      ...
      {filteredTopics.length === 0 ? (
        ...
        >
          <Search className="w-10 h-10 mx-auto mb-3 text-ds-tertiary" />
          ...
          {filteredTopics.map((topic, topicIdx) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-sm font-semibold text-ds-primary tracking-[-0.01em]">
                  {topic.label}
                </h2>
                <span className="text-[10px] text-ds-tertiary ml-1">
              ...
              <div className="space-y-2">
                {topic.terms.map((entry, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`rounded-ds-lg overflow-hidden border transition-all ${
                          isExpanded
                            ? 'border-ds-border'
                            : 'border-ds-hairline'
                        } bg-ds-surface`}
                      >
                        ...
                        <button
                          ...
                          className="w-full px-4 py-3.5 text-left flex items-center gap-3 hover:bg-ds-overlay transition-colors"
                        >

                          <div className="flex-1 min-w-0">
                            <span className="text-sm font-semibold text-ds-primary block">
                              {entry.term}
                            </span>
                            <span className="text-[11px] text-ds-tertiary block truncate">
                              {entry.short}
                            </span>
                          </div>
                          <motion.div
                        ...
                        <AnimatePresence>
                          {isExpanded && (
                            ...
                            >
                              <div className="px-4 pb-4 pt-1 border-t border-ds-hairline">
                                {/* Main explanation */}
                                <p className="text-sm leading-relaxed text-ds-secondary mt-3">
                                  {entry.full}
                                </p>
                                ...
                                {entry.funFact && (
                                  <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ delay: 0.1 }}
                                    className="mt-4 p-3 rounded-ds-md bg-ds-inset border border-ds-hairline flex items-start gap-2.5"
                                  >
                                    <Sparkles className="w-4 h-4 text-ds-secondary flex-shrink-0 mt-0.5" />
                                    <div>
                                      <span className="text-[11px] font-semibold uppercase tracking-[0.05em] text-ds-tertiary block mb-0.5">
                                        Fun Fact
                                      </span>
                                      <p className="text-xs leading-relaxed text-ds-secondary">
                                        {entry.funFact}
                                      </p>
                                    </div>
                                  </motion.div>
